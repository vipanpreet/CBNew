...
*/
{
    ...
    class Item {
        constructor(el) {
            ...
            this.DOM = {el: el};
            // the inner image
            this.DOM.image = this.DOM.el.querySelector('.work__item__img');
            this.renderedStyles = {
    ...
    class SmoothScroll {
        constructor() {
            ...
            this.items = [];
            [...this.DOM.main.querySelectorAll('.work-container > .work__item')].forEach(item => this.items.push(new Item(item)));
    ...
    const preloadImages = () => {
        return new Promise((resolve, reject) => {
            imagesLoaded(document.querySelectorAll('.work__item__img'), {background: true}, resolve);
        });
    };
